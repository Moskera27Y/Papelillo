    ...
    <div className="min-h-screen bg-paper py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-paper-cream rounded-3xl border-2 border-ink p-8 space-y-4 text-ink-muted">
          <p>
            Esta sección está preparada para incluir la política de envíos completa de Papelillo.
          </p>
          <p>
          ...
          <p className="text-sm">
            Edita este archivo en: <code className="bg-paper px-2 py-1 rounded">src/app/envios/page.tsx</code>
          </p>
        </div>
      </div>
    </div>
